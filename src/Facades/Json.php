 ...
 * @method static string encodePretty(string|array $value)
 * 
 * @method static int|float|string|null|bool|array|object decode(int|float|string|null|bool|array|object $json, bool|null $associative = null, int $depth = 512, int $flags = 0)
 * @method static array decodeToArray(int|float|string|null|bool|array|object $json)
 * 
 * @method static \Illuminate\Http\JsonResponse respond(int $status = 200, string $message = '', array $errors = [], array $data = [], array $additional = [], array $headers = [], int $options = 0)
