...
if (
    ...
    function changePercentage(
        ...
        return math(precision: 2)->number(number: subtract(100, divide(multiply($to, 100), $from)));
    }
}
...
if (
    !function_exists('removeEmoji')
) {
    function removeEmoji(mixed $value): mixed
    {
        if (
            !is_string($value) ||
            blank($value)
